...
const modules = {
  today: () =>
    '<section class="ai-brief"><div><span class="spark">✦ AI DAILY BRIEF</span><h2>3 döntés ma +€286 bevételt védhet meg.</h2><p>A rendszer a foglalásokat, customerciklusokat és üres székeket elemezte.</p></div><div class="brief-points"><span>15:30-as üres hely kitölthető a várólistáról</span><span>2 magas kockázatú foglalás megerősítést kér</span><span>14 customer esedékes újrafoglalásra</span></div><button data-action="run-brief">Execution plan →</button></section><div class="grid-4"><article class="kpi"><span>MAI BOOKINGOK</span><b>17</b><small>+3 tegnaphoz képest</small></article><article class="kpi"><span>VÁRHATÓ BEVÉTEL</span><b>€684</b><small>82% kihasználtság</small></article><article class="kpi"><span>VISSZATÉRŐK</span><b>71%</b><small>+8% az előző hónaphoz</small></article><article class="kpi"><span>VÉDETT BEVÉTEL</span><b>€104</b><small>no-show védelem</small></article></div><div class="content-grid"><section class="panel"><div class="panel-head"><h2>Mai székterv</h2><button data-go="calendar">Teljes naptár →</button></div>' +
    schedule() +
    '</section><div class="side-stack"><section class="panel opportunity"><small>EMPTY CHAIR OPPORTUNITY</small><b class="amount">€42</b><p>Demo Barber A 15:30-as helyére 6 megfelelő customer van a várólistán.</p><button data-action="fill-gap">Fill slot with AI</button></section><section class="panel"><div class="panel-head"><h2>Élő aktivitás</h2><small>most</small></div><div class="activity-list"><div class="activity-row"><i></i><div><b>Új foglalás</b><small>Demo Guest F · Classic Cut · Demo Barber A</small></div><time>2p</time></div><div class="activity-row"><i></i><div><b>Kártya előhitelesítve</b><small>Demo Risk Guest A · magasabb kockázat</small></div><time>18p</time></div><div class="activity-row"><i></i><div><b>5★ értékelés</b><small>„Perfekt wie immer”</small></div><time>1ó</time></div></div></section><section class="panel"><div class="panel-head"><h2>Walk-in sor</h2><button data-action="add-walkin">+ Vendég</button></div><div class="walkin"><span><b>Demo Walk-in A</b><small>Skin Fade · 12 perc</small></span><b>Demo Barber A</b></div><div class="walkin"><span><b>Walk-in #18</b><small>Classic Cut · 28 perc</small></span><b>Demo Barber B</b></div></section></div></div>',
  calendar: () =>
