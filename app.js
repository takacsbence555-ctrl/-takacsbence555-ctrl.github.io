...
modules.live = () =>
  ...
  (state.plan === "active" ? "22" : "17") +
  ' appointments</b></div><span class="live-now"><i></i> Updated now</span></div><div class="staff-live"><article><header><span class="avatar lime">SA</span><div><b>Sarah</b><small>BUSY · ends 14:45</small></div></header><div class="seat-progress"><i style="width:82%"></i></div><p>Utilization 92% · next 15:00</p></article><article><header><span class="avatar dark">MK</span><div><b>Demo Barber B</b><small>AVAILABLE · next 15:30</small></div></header><div class="seat-progress"><i style="width:61%"></i></div><p>Capacity for +€2,100 / month</p></article><article class="' +
  (state.liveSlotFilled ? "" : "attention") +
  '"><header><span class="avatar sand">DS</span><div><b>Demo Barber Ael</b><small>' +
...
modules.calendar = () =>
  ...
  (state.manualBooking
    ...
    : "") +
  (state.recurringCreated
    ? '<section class="state-change-banner"><b>Recurring series created · Demo Risk Guestn · 4 visits</b><span>+€168 forecast · next 4 cycles reserved</span></section>'
    : "") +
  (state.plan === "active"
  ...
  "</div>" +
  (state.plan === "active"
    ? '<section class="new-bookings"><h3>New bookings from approved plan</h3><div><span>Demo Customer B · Rebooking</span><b>Wed 17:00 · €42</b></div><div><span>Demo Customer C · Reactivation</span><b>Thu 15:30 · €52</b></div><div><span>Anna K. · Waitlist recovery</span><b>Today 14:30 · €45</b></div></section>'
    : "");
modules.impact = () =>
