...
const modules = {
  ...
  staff: () =>
    '<div class="section-bar"><div><h2>Csapat és teljesítmény</h2><small class="muted">Műszakok, jogosultságok, jutalékok és célok</small></div><button class="primary small" data-action="add-staff">+ Staff</button></div><table class="table"><thead><tr><th>BARBER</th><th>TODAY</th><th>UTILIZATION</th><th>30D REVENUE</th><th>REBOOKING</th><th>RATING</th></tr></thead><tbody><tr><td><b>Demo Barber A</b><br><span class="muted">Fade specialist</span></td><td>7 customer</td><td><span class="badge">91%</span></td><td>€5,840</td><td>78%</td><td>4,9 ★</td></tr><tr><td><b>Demo Barber B</b><br><span class="muted">Senior barber</span></td><td>6 customer</td><td><span class="badge">84%</span></td><td>€5,260</td><td>74%</td><td>4,9 ★</td></tr><tr><td><b>Demo Barber C</b><br><span class="muted">Barber & stylist</span></td><td>4 customer</td><td><span class="badge blue">72%</span></td><td>€4,110</td><td>66%</td><td>4,8 ★</td></tr></tbody></table><div class="content-grid"><section class="panel"><div class="panel-head"><h2>AI Performance Coach</h2><span class="badge blue">HETI</span></div><p>Demo Barber A performs strongly on fade-customer retention. Demo Barber C's chair-side rebooking is 11% below the demo business average.</p><button class="primary small" data-action="coach">Personal coaching plan</button></section><section class="panel"><div class="panel-head"><h2>Következő műszakok</h2></div><div class="walkin"><span><b>Szerda</b><small>10:00–20:00</small></span><b>3 barber</b></div><div class="walkin"><span><b>Csütörtök</b><small>10:00–20:00</small></span><b>3 barber</b></div></section></div>',
  money: () =>
    '<div class="section-bar"><div><h2>Checkout · Demo Customer</h2><small class="muted">Skin Fade + Beard · Demo Barber A · 16:15</small></div><div class="filters"><button>Dayi zárás</button><button>Tranzakciók</button><button>Riportok</button></div></div><div class="checkout"><section class="receipt"><h2>Tételek</h2><div class="line-item"><span><b>Skin Fade + Beard</b><small class="muted">60 perc · Demo Barber A</small></span><b>€52</b></div><div class="line-item addon-line hidden"><span><b>NOIR Matte Clay</b><small class="muted">AI ajánlás · 100 ml</small></span><b>€18</b></div><div class="addon"><span><b>✦ Smart add-on</b><br><small class="muted">Demo Risk Guest A az előző alkalommal Matte Clay-t vett.</small></span><button data-action="add-product">+ €18</button></div><div class="total-line"><span>Összesen</span><b id="checkoutTotal">€52</b></div></section><aside class="pay-panel"><h2>Fizetés</h2><small class="muted">Borravaló</small><div class="tip-row"><button class="active" data-tip="0">Nincs</button><button data-tip="5">5%</button><button data-tip="10">10%</button><button data-tip="15">15%</button></div><div class="payment-methods"><button class="active">◉ Tap to Pay</button><button>▣ Cash</button><button>↗ Payment link</button><button>◇ Gift card</button></div><button class="pay-now" data-action="pay">Pay · <span id="payAmount">€52</span></button><p class="muted" style="font-size:.68rem">Nyugta, jutalék és készlet automatikusan frissül.</p></aside></div>',
  grow: () =>
    '<div class="section-bar"><div><h2>Growth Center</h2><small class="muted">Szegmensek, automatizmusok, kampányok és reviewek</small></div><button class="primary small" data-action="new-campaign">+ Kampány</button></div><div class="campaign-grid"><article class="campaign"><span class="tag">✦ AI REACTIVATION</span><h3>9 at-risk customer</h3><p>6–10 hete nem tértek vissza, pedig korábbi ciklusuk szerint esedékesek.</p><span class="estimate">+€286</span><small>becsült bevétel</small><button data-action="campaign">Kampány előkészítése</button></article><article class="campaign"><span class="tag">EMPTY CHAIR</span><h3>Demo Barber A · ma 15:30</h3><p>Demo Waitlist Guest is the highest-ranked match among 6 waitlist customers.</p><span class="estimate">+€42</span><small>recoverable</small><button data-action="fill-gap">Invite kiküldése</button></article><article class="campaign"><span class="tag">REVIEWS</span><h3>14 review kérhető</h3><p>Boldog, visszatérő customerek személyre szabott review linkkel.</p><span class="estimate">4.9 ★</span><small>jelenlegi átlag</small><button data-action="reviews">Review flow indítása</button></article></div><div class="content-grid"><section class="panel"><div class="panel-head"><h2>Aktív automatizmusok</h2><button>Összes</button></div><table class="table"><tr><td><b>25 napos rebook emlékeztető</b></td><td><span class="badge">AKTÍV</span></td><td>€724 / 30 nap</td></tr><tr><td><b>No-show megerősítés</b></td><td><span class="badge">AKTÍV</span></td><td>€312 védett</td></tr><tr><td><b>Születésnapi ajánlat</b></td><td><span class="badge">AKTÍV</span></td><td>18 foglalás</td></tr></table></section><section class="panel"><div class="panel-head"><h2>Csatornák</h2></div><div class="walkin"><span><b>SMS</b><small>98,7% kézbesítés</small></span><span class="badge">AKTÍV</span></div><div class="walkin"><span><b>WhatsApp</b><small>Human handoff engedélyezve</small></span><span class="badge">AKTÍV</span></div><div class="walkin"><span><b>Email</b><small>Branded template</small></span><span class="badge">AKTÍV</span></div></section></div>',
  inventory: () =>
